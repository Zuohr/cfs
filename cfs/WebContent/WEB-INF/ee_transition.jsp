					...
					<form class="form-horizontal" id="transition_form">
						...
						<div class="form-group">
							...
							<span class="label label-danger"
								style="position: relative; top: 10px;">${requestScope.errors["0"] }</span>
						</div>
						...
						<c:forEach var="fund" items="${requestScope.fund_list }">
							<div class="form-group">
								...
								<span class="label label-danger"
									style="position: relative; top: 10px;">${requestScope.errors[fund.id] }</span>
							</div>
						</c:forEach>

						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="submit" form="transition_form"
									class="btn btn-primary" name="btn_transition" value="submit">Submit</button>

								<button type="submit" form="transition_form"
									class="btn btn-default" name="btn_transition" value="cancel">Cancel</button>
							</div>
						</div>
					</form>
